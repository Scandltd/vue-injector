import Vue from 'vue'
import VueInjector, { Injectable } from '../../../src/index'
...
describe('registerComponent service', () => {
  ...
  it('register not Injectable', () => {
    ...
    expect(() => injector.provider.registerService(app, 'Service', Service)).toThrowError('[@scandltd/vue-injector] no decorator Injectable or extends Inject')
    expect(() => injector.provider.registerService(app, 'ServiceTwo', ServiceTwo)).toThrowError('[@scandltd/vue-injector] providers not object')
  })
})
